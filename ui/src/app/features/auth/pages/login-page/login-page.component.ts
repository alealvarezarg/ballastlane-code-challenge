...
import { createLoginForm } from '../../validators/login-form.validators';
...
export class LoginPageComponent {
  ...
  protected readonly status = this.store.selectSignal(authFeature.selectLoginStatus);
  ...
  submit(): void {
    ...
    this.store.dispatch(authActions.loginRequested({ request: this.form.getRawValue() }));
  }
}
